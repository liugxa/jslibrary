...
//*******************************************************************************
/*
function toggleHelpState(_this){
	if(_this != null){
		if(_this.innerHTML == VEM_SERVICE_EDITOR_TABLE_SHOWHELP){
			_this.innerHTML = VEM_SERVICE_EDITOR_TABLE_HIDEHELP;
		}else{
			_this.innerHTML = VEM_SERVICE_EDITOR_TABLE_SHOWHELP;	
		}
	}

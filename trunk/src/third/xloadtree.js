...
function _xmlTreeToJsTree(oNode) {
	...
	//later define node value, based to xLoadTree format
	var selectclass = oNode.getAttribute("selectclass");
	var showdisplay = oNode.getAttribute("showdisplay");
	// create jsNode
	//if(showdisplay == "" || showdisplay == null || showdisplay == "false") {
	//	showdisplay = false;
 	//	alert(showdispaly);
	//}
	...
	if(selectclass != "")
		jsNode.selectclass = selectclass;
    
	if(showdisplay != "")
		jsNode.showdisplay = showdisplay;
...
function _xmlFileLoaded(oXmlDoc, jsParentNode) {
	...
	if( oXmlDoc == null || oXmlDoc.documentElement == null) {
		//alert(messageValue);
		//canNotLoadConsumerTree() method has been defined in the consumerTree.jsp file.
		canNotLoadConsumerTree();
		...
		jsParentNode.add(_xmlTreeToJsTree(root), true);
		// loop through all tree children
		webFXTreeConfig.rootText = root.getAttribute("text");
		/*
